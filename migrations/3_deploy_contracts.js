...
function storeDB(id1, name1, address1, id2, name2, address2) {
    const contratto_1 = Contract.create({id: id1, name: name1, address: address1, id_evento: 1});
    const contratto_2 = Contract.create({id: id2, name: name2 + id1, address: address2, id_evento: 1});
}
...
module.exports = async function (deployer) {
    ...
    const evento_info = await EventoService_.storeItem(1, 'Concerto X', 'Macerata', '20/12/2022', '21:00', 'Artista Y', 1500);
